			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
				...
				<form class="form-horizontal" action="user data edit tb.php?id=<?php echo $id?>" method="post">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="empNo" type="text"  placeholder="" value="<?php echo $data['empNo'];?>" readonly>
						</div>
					</div>
					...
					<div class="control-group">
						<label class="control-label">EGAT Email</label>
						<div class="controls">
					...
					<div class="form-actions">
						...
						<a class="btn" href="user data.php">กลับ</a>
					</div>
				</form>
			</div>               
		</div> <!-- /container -->	
